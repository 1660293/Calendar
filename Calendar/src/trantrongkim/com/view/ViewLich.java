...
public class ViewLich extends JFrame{
	public ViewLich(Lich_Tay lt)
	{
		...
		jf.setSize(550,550);
		less=new JButton(new ImageIcon("D:\\Learn\\More_Learn\\Icon\\Number\\less.png"));
		plus=new JButton(new ImageIcon("D:\\Learn\\More_Learn\\Icon\\Number\\plus.png"));
		plus.setName(">");
		less.setName("<");
	...
	// tạo ngày tháng năm
	private void createLich(Lich_Tay lt)
	{
		// tạo lưới cho lịch
		...
		for(int i=0;i<42;i++)
		{
			...
			{
				flagDay=true;
				JButton btnchild=new JButton(new ImageIcon(getIcon("D:\\Learn\\More_Learn\\Icon\\Number\\f", n)));
				...
				JButton btnchild=new JButton(new ImageIcon(getIcon("D:\\Learn\\More_Learn\\Icon\\Number\\", n)));
	...
	private void createHand(Lich_Tay lt)
	{
	...
	public void initUI(Lich_Tay lt) {
		createLich(lt);
		createHand(lt);
	...
	public void changIconJlabel()
	{
		...
		for(int i=0;i<42;i++)
		{
			...
			if(flagDay==false&&lt.layNgay()==n)
			{
				...
				btn[i].setIcon(new ImageIcon(getIcon("D:\\Learn\\More_Learn\\Icon\\Number\\f", n)));
				btn[i].setName(n.toString());
				flagDay=true;
			}
			else {
				btn[i].setBorder(BorderFactory.createLineBorder(Color.BLACK,FlowLayout.CENTER));
				btn[i].setIcon(new ImageIcon(getIcon("D:\\Learn\\More_Learn\\Icon\\Number\\", n)));
				btn[i].setName(n.toString());
			}
				...
				public void actionPerformed(java.awt.event.ActionEvent e) {
					...
					for(int i=0;i< 42;i++)
					{
						if(btn[i].getName().compareToIgnoreCase(lt.layNgay().toString())==0)
						{
							...
							btn[i].setIcon(new ImageIcon(getIcon("D:\\Learn\\More_Learn\\Icon\\Number\\",text1)));
						}
					}
					text2=text2.parseInt(btn[ibtn].getName());
					btn[ibtn].setIcon(new ImageIcon(getIcon("D:\\Learn\\More_Learn\\Icon\\Number\\f",text2)));
					if(ibtn<14)
					{
						if(text2>8)
						{							
